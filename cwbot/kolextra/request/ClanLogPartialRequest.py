from cwbot.kolextra.request.GenericPartialRequest import GenericPartialRequest
...
class ClanLogPartialRequest(GenericPartialRequest):
    """Retrieves the clan activity log -- but stops after receiving fax data
    for the first fax"""
